...
import 'package:fomoplay/jilli_dir/jilli_view_model/jilli_view_model.dart';
import 'package:fomoplay/view_modal/services_view_model.dart';
import 'package:wakelock_plus/wakelock_plus.dart';
import 'package:fomoplay/utils/routes/routers.dart';
...
import 'package:fomoplay/view/me/controller/me_controller.dart';
    ...
    return MediaQuery(
      ...
      child: MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider(create: (context) => SubordinateTierViewModel()),
          ChangeNotifierProvider(create: (context) => SubordinateDataViewModel()),
          ...
          ChangeNotifierProvider(create: (context) => VipRewardReceiveViewModel()),
